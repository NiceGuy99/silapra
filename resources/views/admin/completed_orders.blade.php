    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold mb-4">Semua Permintaan yang Selesai</h3>
                    ...
                    <div class="card shadow-sm">
                        <div class="table-responsive p-3">
                            <table class="table table-hover align-middle mb-0" id="completedOrdersTable">
                                <thead>
                                    <tr>
                                        <th>No. RM</th>
                                        <th>Nama Pasien</th>
    ...
    <script>
        $(document).ready(function() {
            $('#completedOrdersTable').DataTable({
                responsive: true,
                order: [[9, 'desc']], // Sort by completion date
                pageLength: 10,
            });
        });
    </script>
